...
{   
   ...
   {    
       $r=(new summaryController)->pass($act='transferencia');
        ...
        return view('Accounting.transfer.create',['data'=>$account,'divisa'=>$divisa,'totalfinal'=>$totalfinal]);
   ...
   public function consul($id){
    ...
    public function crear(Request $request){
       ...
       $r=(new summaryController)->pass($act='transferencia');
        ...
        return view('Accounting.transfer.create',['summary'=>$summary,'divisa'=>$divisa,'data'=>$account,'data2'=>$categories]);
  ...
  public function edit(Request $request, $id){
    ...
    $add = summary::where('id',$b)->first();
      ...
      return view('Accounting.transfer.edit',['add'=>$add,'out'=>$out,'account'=>$account]);
