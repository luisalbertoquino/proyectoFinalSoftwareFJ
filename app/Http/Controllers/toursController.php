...
class toursController extends Controller
{
     public function index()
   {
      $r=(new summaryController)->pass($act='tours');
        ...
        $tours = tours::all();
        return view('Accounting.tours.tours',['tours'=>$tours]);
   ...
   public function save(Request $request)
	...
	public function edit(Request $request, $id){
      ...
      $r=(new summaryController)->pass($act='tours');
    		...
    		return view('Accounting.tours.edit',['data'=>$data,'data1'=>$data1]);
   ...
   $r=(new summaryController)->pass($act='tours');
  		...
  		if($data1 = summary::where('tours_id',$id)->exists()){
  			$messaje = array(
                  ...
                  'tipo'=>'1');
  	     return view('Accounting.tours.error',['messaje'=>$messaje]);
  		}else{
    ...
    public function view_attr($id=null){
    	...
    	return view('Accounting.tours.attr',['tours'=>$tours]);
    }
    ...
    $r=(new summaryController)->pass($act='tours');
        ...
        return view('Accounting.tours.tourdetail',['data'=>$data,'tour'=>$tour,'divisa'=>$divisa]);
    ...
    public function fecha(Request $request, $id=null){
      ...
      return view('Accounting.tours.fecha',['summary'=>$summary,'divisa'=>$divisa,'data'=>$account,'data2'=>$categories,'totalfinal'=>$totalfinal,'totalfinaliva'=>$totalfinaliva,'totalfinalivae'=>$totalfinalivae,'tours'=>$tours,'namefecha'=>$namefecha,'nametour'=>$nametour,'movimientosa'=>$movimientosa]);
