...
class futuroController extends Controller
{
    ...
    public function index(Request $request)
    {
        $r = (new summaryController)->pass($act = 'm_futuros');
            ...
            return view('Accounting.futuro.futuro', ['summary' => $summary, 'divisa' => $divisa, 'data' => $account, 'data2' => $categories, 'totalfinal' => $totalfinal, 'totalfinaliva' => $totalfinaliva, 'totalfinalivae' => $totalfinalivae, 'tours' => $tours, 'alerta' => $alerta]);
    ...
    public function edit(Request $request, $id)
    {
        ...
        $r = (new summaryController)->pass($act = 'm_futuros');
            ...
            return view('Accounting.futuro.edit', ['data' => $data, 'account' => $account, 'categories' => $categories]);
