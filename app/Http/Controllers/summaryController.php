...
class summaryController extends Controller
{
   ...
   {    
    $permisos = permissionsi::where('id_user',Auth::id())->first();
   ...
   {    
        ...
        return view('Accounting.summary.summary',['summary'=>$summary,'divisa'=>$divisa,'data'=>$account,'data2'=>$categories,'totalfinal'=>$totalfinal,'totalfinaliva'=>$totalfinaliva,'totalfinalivae'=>$totalfinalivae,'tours'=>$tours]);
   ...
   public function crear(Request $request){
     ...
     $r=$this->pass('movimientos');
      ...
      $tours = producto::get();
        ...
        return view('Accounting.summary.create',['data'=>$data,'data2'=>$data2,'type'=>$type,'tours'=>$tours]);
  ...
  public function edit(Request $request, $id){
    ...
    $r=$this->pass('movimientos');
      ...
      return view('Accounting.summary.edit',['data'=>$data,'account'=>$account,'categories'=>$categories,'tours'=>$tours]);
