...
class permissionsController extends Controller
{
   ...
   {	
            ...
            $user = permissionsi::where('id_user',$id)->get();
            $user2 = permissionsi::where('id_user',$id)->first();
            $idd=$user2->id_user;
            return view('Accounting.users.permissions',['user'=>$user,'iduser'=>$idd]);
      }

        public function update(Request $request, $id)
   {
  		$user = permissionsi::where('id_user',$id)->first();
  		$idruta =$id;
  		$id = $user->id;
