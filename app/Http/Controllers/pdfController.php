...
class pdfController extends Controller
{
    ...
    public function invoice()
    {
        ...
        $date = date('Y-m-d');
        $invoice = "2222";
        $view =  \View::make('Accounting.pdf.invoice', compact('data', 'date', 'invoice'))->render();
     ...
     public function index(Request $request)
   {
    ...
    $r=(new summaryController)->pass($act='pdf');
        ...
        $hoy2=date('Y-m-d H:m:s',strtotime('today'));
           ...
           $view =  \View::make('Accounting.pdf.invoice', compact('divisa', 'summary', 'account', 'categories','totalfinal','totalfinaliva','totalfinalivae','hoy2','atributos','atributostours','tours'))->render();
