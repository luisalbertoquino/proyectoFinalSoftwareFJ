                  ...
                  <div class="col-md-8">
                      <select class="js-example-basic-single form-control "  data-live-search="true" name="id_client_fk" id="id_client_fk" required="true" >
                        ...
                        @foreach ($cliente as $cliente)
                            @if ($cliente->estado==1){
                            <option id="option"  value="{{$cliente->numeroDocumento}}-{{$cliente->nombre}}" >{{$cliente->numeroDocumento}}-{{$cliente->nombre}}</option>
                            }
                          @endif
                        @endforeach
                      </select>
              ...
              <table class="table table-bordered" id="datatable" name="datatable" width="100%" cellspacing="0">
                ...
                <thead class="thead-dark">
                  ...
                  <tr>
                    ...
                    <th style="text-align: center;">Serial Venta</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width:80px;text-align: center;">{{$venta->serialVenta}}</td>
                    <td style="width:80px;text-align: center;">{{$venta->usuario['nombre']}}&nbsp{{$venta->usuario['apellido']}}</td>
                    <td style="width:100px;text-align: center;">${{$venta->subtotal}}.00</td>
                    <td style="width:100px;text-align: center;">${{$venta->iva}}.00</td>
                    <td style="width:100px;text-align: center;">${{$venta->total}}.00</td>
                    <td style="width:100px;text-align: center;">
                        @if ($venta->clientor['estado']==1)
                          {{$venta->clientor['numeroDocumento']}}-{{$venta->clientor['nombre']}}
                      @else
                          No exist
                      @endif
                    </td> 
                    <td style="width:100px;text-align: center;">{{$venta->fechaEmision}}</td>
                  </tr>
                  @php
    ...
    @section('js')
      ...
      <script>
        function generarReporte() {
                      ...
                      var columns = ["#Venta", "SerialVenta", "Vendedor", "Subtotal", "Iva", "Total", "Cliente", "FechaVenta"];
                      ...
                      img.onload = function () {
                        ...
                        doc.text(50, 60, "El presente informe es para dar a conocer las ventas realizadas en los parametros dados");
