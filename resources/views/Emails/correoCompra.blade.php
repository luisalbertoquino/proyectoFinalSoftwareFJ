...
<html lang="en"><head>
    ...
    <?php
            ...
            $acum2 = 0;
            $pinaculo=0;
            //$acum=$compraOp->serieComprobante;
            //$acum2=$compraOp->numeroComprobante;
            foreach ($compraFull as &$as) {
               $pinaculo=$as->serieComprobante;
            }
            if ($pinaculo ==0) {
            $acum = $acum+1;
            $acum2=$acum2+1;
                                        ...
                                        <td colspan="2">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        Serie Comprobante#  :{{$acum }}<br>
                                                        Numero Comprobante#  :{{$acum2 }}<br>
