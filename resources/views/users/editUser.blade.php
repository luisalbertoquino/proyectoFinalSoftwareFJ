        ...
        <ol class="breadcrumb">
          ...
          <div class="table-responsive">
            <div class="card mb-3" style="width: 40rem; margin: auto"> 
                <div class="card-header" style="text-align: center;font-size:20px; color:#34495E ;font-weight: italic;">ACTUALIZAR USUARIO&nbsp&nbsp<i class="fa fa-address-book" aria-hidden="true"></i>
                    <!--boton regresar-->
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/user/{{$piola}}" enctype="multipart/form-data">
                            @method('PATCH')
                            {{csrf_field()}}
                            ...
                            @if($userRol->slug=='administrador')
                            <div class="form-group row" hidden>
                                <label for="permissions_checkbox_list" class="col-md-4 col-form-label text-md-right">{{ __('Seleccionar nuevos permisos') }}</label>
                                <div class="col-md-8">
                                            ...
                                            @if($rolePermissions != null)
                                                <div id="user_permissions_checkbox_list" class="col-md-8">
                                                    ...
                                                    <div class="custom-control custom-checkbox" class="col-md-8">
                                                        <input class="custom-control-input" type="checkbox" name="permissions[]" id="{{$permission->slug}}" value="{{$permission->id}}" @if(in_array($permission->nombre,$userPermissions->pluck('nombre')->toArray(), true)) checked @endif>
                    ...
                    $.ajax({
                        ...
                        $.each(data, function(index, element){
                            $(permissions_checkbox_list).append(
                                ...
                                '<input class="custom-control-input" checked type="checkbox"  name="permissions[]" id="'+element.slug+'"value="'+element.id+'" >'+
